 ...
 * 
 * eg.在web.xml中设置 <filter> <filter-name>cacheControlHeaderFilter</filter-name>
 * <filter
 * -class>org.springside.modules.web.CacheControlHeaderFilter</filter-class>
 * <init-param> <param-name>expiresSeconds</param-name>
 * <param-value>31536000</param-value> </init-param> </filter> <filter-mapping>
 * <filter-name>cacheControlHeaderFilter</filter-name>
 * <url-pattern>/images/*</url-pattern> </filter-mapping>
 * 
 * @author calvin
 */
